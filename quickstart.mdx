...
<Steps>
  <Step title="Open the controller menu">
    ...
    <img src="/images/controller-menu.png" alt="Controller menu" />
  </Step>

  <Step title="Select 'Set Custom Text...'">
    A dialog will appear prompting you to enter your text.
    
    <img src="/images/set-text-dialog.png" alt="Set custom text dialog" />
  </Step>
...
<Steps>
  <Step title="Open the adjustment panel">
    ...
    <img src="/images/adjustment-panel.png" alt="Position adjustment panel" />
  </Step>
...
<CardGroup cols={2}>
  <Card title="Explore features" icon="sparkles">
    Learn about advanced customization options and use cases
  </Card>
  <Card title="Contribute" icon="code-pull-request">
    Check out the source code and contribute to MenuBarText on GitHub
  </Card>
  ...
  <Card title="Share feedback" icon="comments">
    Let us know how you're using MenuBarText and what features you'd like to see
  </Card>
</CardGroup>